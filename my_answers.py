...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below.
        #
        self.activation_function = self._sigmoid # Replace 0 with your sigmoid calculation.
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            final_outputs, hidden_outputs = self.forward_pass_train(X, y)
    ...
    def forward_pass_train(self, X, y):
